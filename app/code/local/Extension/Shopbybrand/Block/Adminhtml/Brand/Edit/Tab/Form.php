<?php
class Extension_Shopbybrand_Block_Adminhtml_Brand_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare tab form's information
     *
     * @return Extension_Shopbybrand_Block_Adminhtml_Shopbybrand_Edit_Tab_Form
     */
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('shopbybrand_form', array(
            'legend'=>Mage::helper('extension_shopbybrand')->__('Brand information')
        ));

        $fieldset->addField('name', 'text', array(
            'label'        => Mage::helper('extension_shopbybrand')->__('Name'),
        ...
        $fieldset->addField('description', 'editor', array(
            'name'      => 'description',
            'label'     => Mage::helper('extension_shopbybrand')->__('Description'),
            'title'     => Mage::helper('extension_shopbybrand')->__('Description'),
		...
		$fieldset->addField('status', 'select', array(
            'label'     => Mage::helper('extension_shopbybrand')->__('Status'),
            'name'      => 'status',
            'values'    => Mage::getSingleton('extension_shopbybrand/status')->getOptionHash(),
