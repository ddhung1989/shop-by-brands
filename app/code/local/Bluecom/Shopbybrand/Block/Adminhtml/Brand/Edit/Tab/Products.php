<?php
class Bluecom_Shopbybrand_Block_Adminhtml_Brand_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     public function __construct()
    {
		...
		$this->setId('bluecom_shopbybrand_products_grid');
    ...
    protected function _prepareColumns()
    {
       $this->addColumn('in_products', array(
        ...
        $this->addColumn('type', array(
            'header'    => Mage::helper('bluecom_shopbybrand')->__('Type'),
            'width'     => 100,
            'index'     => 'type_id',
            'type'      => 'options',
            'options'   => $newTypes,
        ...
        $this->addColumn('set_name', array(
            'header'    => Mage::helper('bluecom_shopbybrand')->__('Attrib. Set Name'),
            'width'     => 130,
        ...
        $this->addColumn('visibility', array(
            'header'    => Mage::helper('bluecom_shopbybrand')->__('Visibility'),
            'width'     => 90,
            'index'     => 'visibility',
            'type'      => 'options',
        ...
        $this->addColumn('sku', array(
            'header'    => Mage::helper('bluecom_shopbybrand')->__('SKU'),
            'width'     => 80,
            'index'     => 'sku'
        ));

        $this->addColumn('price', array(
            'header'        => Mage::helper('bluecom_shopbybrand')->__('Price'),
            'type'          => 'currency',
            'currency_code' => (string) Mage::getStoreConfig(Mage_Directory_Model_Currency::XML_PATH_CURRENCY_BASE),
            'index'         => 'price'
        ));
        $this->addColumn('position', array(
            'header'            => Mage::helper('bluecom_shopbybrand')->__('Position'),
            'name'              => 'position',    
            'index'             => 'position',
            'width'             => 0,
            'editable'          => true,
    ...
    public function getBrand(){
        ...
        $brand = Mage::getModel('bluecom_shopbybrand/brand')->load($brandId);
        return $brand;
    }
}